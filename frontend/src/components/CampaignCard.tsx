    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        <img
          ...
          onError={(e) => {
            (e.target as HTMLImageElement).src = 'https://via.placeholder.com/400x200?text=Campaign';
          }}
        />
        {/* Gradient Overlay */}
      ...
      {/* Content */}
      <div className="p-5">
        <h3 className="font-heading font-semibold text-dark-100 mb-2 line-clamp-2 group-hover:text-primary-400 transition-colors">
          {campaign.title}
        </h3>
        
        <p className="text-sm text-dark-400 mb-5 line-clamp-2 font-body">

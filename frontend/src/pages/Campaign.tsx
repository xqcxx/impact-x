...
export function CampaignPage() {
  ...
  if (!campaign) {
    return (
      <div className="max-w-md mx-auto mt-20 glass-card text-center py-16 px-6">
        ...
        <h2 className="text-xl font-heading font-semibold text-dark-100 mb-2">
          Campaign not found
        </h2>
  ...
  return (
    <>
      {campaign && <SocialMeta data={shareData} campaignId={campaign.id} />}
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="relative rounded-2xl overflow-hidden glass-card group">
            ...
            <div className="absolute top-4 left-4 flex gap-2">
              ...
              {campaign.claimed && (
                <span className="badge px-2 py-0.5 bg-dark-700 text-dark-400">Claimed</span>
              )}
            </div>
          </div>
          ...
          <div className="glass-card p-6">
            <h2 className="text-lg font-heading font-semibold text-dark-100 mb-4">
              Campaign Creator
            </h2>
        ...
        <div className="space-y-6">
          ...
          <div className="glass-card p-6 sticky top-28 border-t-4 border-t-primary-500">
            ...
            {isOwner && !campaign.claimed && (
              <button className="w-full btn-secondary flex items-center justify-center gap-2 mt-4">
